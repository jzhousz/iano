...
public class DummySVMClassifier implements SavableClassifier
{
    int dimension;
    int maxClassNum = 0;
   ...
   public DummySVMClassifier(java.util.HashMap<String,String> parameters)
   {
	  if(parameters != null && parameters.containsKey(KEY_PARA))
          initSVMParameters(parameters.get(KEY_PARA));
 	  else
    ...
    public DummySVMClassifier(int dimension, String parameters)
   {
	 this.dimension = dimension;
     initSVMParameters(parameters);
   }

   public DummySVMClassifier(int dimension)
   {
     this.dimension = dimension;
     initSVMParameters(annotool.Annotator.DEFAULT_SVM);
   }
