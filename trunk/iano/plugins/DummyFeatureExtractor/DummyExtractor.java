...
public class DummyExtractor implements FeatureExtractor
{
   ...
   public DummyExtractor(java.util.HashMap<String, String> parameters)
   {
 	   if (parameters != null && parameters.containsKey(LEVEL_KEY))
 		     totallevel = Integer.parseInt(parameters.get(LEVEL_KEY));
   } 
   
   public DummyExtractor(annotool.io.DataInput problem, java.util.HashMap<String, String> parameters)
   {
   ...
   public DummyExtractor(annotool.io.DataInput problem, int level, int stackindex)
   {
   ...
   public DummyExtractor(byte[][] data, int length, int width, int height)
   {
   ...
   public DummyExtractor(int level, byte[][] data, int length, int width, int height)
   {
   	   totallevel = level;
	   totalwidth = width;
	   totalheight = height;
   ...
   //pass one image
   public DummyExtractor(int level, byte[] data, int width, int height)
   {
   	   totallevel = level;
	   totalwidth = width;
	   totalheight = height;
