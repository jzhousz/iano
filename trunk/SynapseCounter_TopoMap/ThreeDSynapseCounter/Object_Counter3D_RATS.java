...
public class Object_Counter3D_RATS implements PlugIn, AdjustmentListener, TextListener, Runnable {
    static final String pluginName = "Object Counter3D with RATS";
    boolean debug = false;
    ...
    public boolean setupGUI(String arg) {
        ...
        IJ.register(Object_Counter3D_RATS.class); // static fields preserved when plugin is restarted
        //Reset the threshold
        ip.resetThreshold();
        img.updateAndDraw();
        return true;
