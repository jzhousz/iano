...
import ij.util.*;
/**
 * Modified to facilitate calling from another program.  J Zhou 3/12/2012
 *
...
public class RATSForAxon  {
	...
	public ImagePlus run(ImageProcessor ip, String opt) {
        this.ip = ip;
       ...
       //String opt = Macro.getOptions(); "noise=10 lambda=3 min=5"
