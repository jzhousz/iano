...
public class Axon_TopoMap_Inclusive_AutoEnhance implements PlugIn, AdjustmentListener, TextListener {
    static final String pluginName = "Axon_TopoMap_Inclusive_AutoEnhance";
	...
	show_mask = gd.getNextBoolean();     show_mask_default = show_mask;
        ...
        IJ.register(Axon_TopoMap_Inclusive_AutoEnhance.class); // static fields preserved when plugin is restarted
        //Reset the threshold
        ip.resetThreshold();
        img.updateAndDraw();
        return true;
