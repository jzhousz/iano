...
//revised from http://rsb.info.nih.gov/ij/plugins/download/AVI_Reader.java
//add a public method to return total length
/**
* Revised from http://rsb.info.nih.gov/ij/plugins/download/AVI_Reader.java
* add a public method to return total length
* 
* @author  Shawn
*/
public class AVIHeaderReader extends VirtualStack implements PlugIn {
   ...
   //the input file
     ...
     *  @param arg String 'arg' may be used to select the path.
     */
    ...
    */
    ...
    //added from the original file to get the total frames. 
    public int getTotalFrames(String path)
    {
 	   ...
 	   {
 		   System.out.println("Isse in reading avi header file.");
 	   }
