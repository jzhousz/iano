...
/**
 * The class used to calculate the test images containing adjoining larvae.
 * 
...
public class Tester
{
	 ...
	 * @param larvaImage The image containing adjoining larvae.
	 */
...
//		FileManager.deleteAllFiles( imageTestDir );
	...
	/**
	 * Save the probabilities of the candidate cases to a CSV file.
