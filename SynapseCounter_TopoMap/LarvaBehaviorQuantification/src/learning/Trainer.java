...
/**
 * The class used to train a statistical shape model.
 * 
...
//	String imageDir = PropertyManager.getPath() + "training/"; // the input image folder
	...
	public static String imageDiscardDir = PropertyManager.getPath() + "discarding_larva/";
	...
	/**
	 * Start to train the statistical model.
	 */
	...
	/**
	 * Get the training data from a file.
	...
	/**
	 * Convert larvae in an image to the data in CSV file.
	 */
