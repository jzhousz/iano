...
//		PixelPutter.putPixels(impSkeleton, centerPt, 2, 2, Color.pink);
		...
		// print the vectors closet to the center of skeleton after translation and transformation on the output images
//		PixelPutter.putPixelsOrigin(pointOrigin, impSkeleton, VectorManager.newPoint( ptsChosenMatr.get(NUM_POINTS/2) ) , 4, 4, Color.cyan);
		
		// print the end point vectors after translation and transformation on the output images
//		PixelPutter.putPixelsOrigin(pointOrigin, impSkeleton, VectorManager.newPoint( ptsChosenMatr.get(0) ) , 4, 4, Color.red);
//		PixelPutter.putPixelsOrigin(pointOrigin, impSkeleton, VectorManager.newPoint( ptsChosenMatr.get(NUM_POINTS-1) ), 4, 4, Color.red);
...
//		for(Point pt : ptsSkeletonChosen)
//		{
//			PixelPutter.putPixels(imagePlusBin_ske, pt, 2, 2, Color.orange);
//		}
...
//		dimData.add(radius);
	...
	public static double[] get18PointIndex(int numPoints, int totalPoints)
	{
		double indexDoublePtsChosen[] = new double[numPoints];
		
		indexDoublePtsChosen[0] = 1;
		indexDoublePtsChosen[16] = totalPoints;
		indexDoublePtsChosen[8] = ( indexDoublePtsChosen[0] + indexDoublePtsChosen[16]) / 2;
		
		indexDoublePtsChosen[4] = ( indexDoublePtsChosen[0] + indexDoublePtsChosen[8]) / 2;
		indexDoublePtsChosen[12] = (indexDoublePtsChosen[8] + indexDoublePtsChosen[16]) / 2;
		...
		indexDoublePtsChosen[10] = (indexDoublePtsChosen[8] + indexDoublePtsChosen[12]) / 2;
		indexDoublePtsChosen[14] = (indexDoublePtsChosen[12] + indexDoublePtsChosen[16]) / 2;
		...
		indexDoublePtsChosen[9] = (indexDoublePtsChosen[8] + indexDoublePtsChosen[10]) / 2;
		indexDoublePtsChosen[11] = (indexDoublePtsChosen[10] + indexDoublePtsChosen[12]) / 2;
		indexDoublePtsChosen[13] = (indexDoublePtsChosen[12] + indexDoublePtsChosen[14]) / 2;
		indexDoublePtsChosen[15] = (indexDoublePtsChosen[14] + indexDoublePtsChosen[16]) / 2;
