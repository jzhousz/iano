...
//				+ ",angRef: " + larva.getAngleRefCenterN1());
		...
		annotate("Segmentation Technique: " + larva.getSegmentTechnique()  );
	}
	...
	* @return None.
	*/
	public static void annotate(ImagePlus imagePlus, Point pointTopLeft, String text, Color color, int fontSize) 
	{
