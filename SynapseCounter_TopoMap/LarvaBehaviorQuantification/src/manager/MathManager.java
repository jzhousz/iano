...
{
	/**
     * Find all the points on a line passing two points.
     * 
     * @param grid The coordinate.
     * @param point1 The first point.
     * @param point2 The second point.
     * @return A ArrayList containing all the points composed of the line.
     */
    public static ArrayList<Point> findLinePoints(Point[][] grid, Point point1, Point point2) 
    {                    
	...
	/**
	* Get angle between two lines (line 1: pt11 and pt12, line 2: pt21 and pt22).
	* 
	* @param pt11 A point in line 1.
	* @param pt12 A point in line 1.
	* @param pt21 A point in line 2.
	* @param pt22 A point in line 2.
	* @return The angle between two lines.
	*/
	public static double getAngleBetween2Lines(Point pt11, Point pt12, Point pt21, Point pt22)
	{
		double angle1 = Math.atan2(pt11.getY() - pt12.getY(), pt11.getX() - pt12.getX());
		double angle2 = Math.atan2(pt21.getY() - pt22.getY(), pt21.getX() - pt22.getX());
...
//	    return angle1 - angle2;
	...
	/**
	* Print the double array horizontally.
	* 
	* @param m The matrix.
	*/
	public static void printHorizontal(double[][] m)
	{
	...
	*/
	...
	/**
	* Get a rounded integer from a double value.
	* 
	...
	*/
	...
	{
		int intRounded = (int) Math.round(value);
		return intRounded;
	}
...
//	}
	 ...
	 */
	public static LinkedHashSet<Integer> getRollingFrame(ArrayList<Larva> listLarva, PropertyManager prop,
...
//				featuresOfLarva.setIsDistSidewaysPos(false);
	 ...
	 */
	public static Point getAveragePoint2( Point point1, Point point2 )
	{
