...
//		textArea.append(String.valueOf((char) b));
		...
		// redirects data to the text area
//		textAreaException.append(String.valueOf((char) b));
		// scrolls the text area to the end of data
//		textAreaException.setCaretPosition(textAreaException.getDocument().getLength());
	}
	
//	private JTextArea textArea;
//	private JTextArea textAreaException;
//
//	public CustomOutputStream(JTextArea textArea, JTextArea textAreaException)
//	{
//		this.textArea = textArea;
//		this.textAreaException = textAreaException;
//	}
