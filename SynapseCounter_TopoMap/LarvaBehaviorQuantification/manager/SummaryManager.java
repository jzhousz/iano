...
public class SummaryManager {
	...
	public SummaryManager(ArrayList<FeaturesOfLarva> listFeaturesOfLarva)
	{
...
//		for( FeaturesOfLarva larva : listFeaturesOfLarva )
//		{
//			if( larva.getFeaturesOfLarvaPrevious() != null )
//			{
//				System.out.println("[listFeaturesOfLarva] larva frameId: " + larva.getFrameId()+", previous frameId:"+larva.getFeaturesOfLarvaPrevious().getFrameId());
//			}else{
//				System.out.println("[listFeaturesOfLarva] larva frameId: " + larva.getFrameId()+", previous frameId:none");
//			}
//		}
