...
////////////////parameters//////////////////////////////
// soma
backgroundSubtractionRadius = 50;
somaThreshold = 9;
dilateSomaTimes = 3;
// dendrite
dendriteThreshold = 24;
dilateDendriteTimes = 6;
// counting
...
run("Paste");
// segment
run("Robust Automatic Threshold Selection", "noise="+ segmentationThreshold +" lambda=3 min=54");
//count
run("Invert LUT");
