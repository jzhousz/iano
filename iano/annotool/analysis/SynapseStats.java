...
public class SynapseStats implements Runnable {
	...
	static final double FINE_TH = 6.0;
	static final double MEDIUM_TH = 15.0;
	...
	public void run() {
		...
		//Visualize fine branches in 34th frame
		/*int tempz = 34;
