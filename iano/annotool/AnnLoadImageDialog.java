...
public class AnnLoadImageDialog extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() == loadImageB)
		{
			...
			boolean displayOK = controlPanel.getTablePanel().displayOneImageTable(Annotator.dir, Annotator.targetFile, Annotator.ext);
			...
			controlPanel.getOutputPanel().setOutput("Images loaded from "+dirField.getText().trim()+ ".");
			controlPanel.getOutputPanel().setOutput("Target file loaded from "+Annotator.targetFile+ ".");
		...
		else if (e.getSource() == combinedLoadImageB)
		{
		   //mode 2 training/testing
			...
			{	
			   ...
			   displayOK = controlPanel.getTablePanel().displayTwoImageTables(Annotator.dir, Annotator.targetFile, Annotator.ext, Annotator.testdir,Annotator.testtargetFile,Annotator.testext);
			}
			else
			   displayOK = controlPanel.getTablePanel().displayTwoImageTables(Annotator.dir, Annotator.targetFile, Annotator.ext, Annotator.testdir, Annotator.testext);
			...
			//write some information about the opened image in the outputpanel ...
			controlPanel.getOutputPanel().setOutput("Training Images loaded from "+dirField.getText().trim()+ ".");
			controlPanel.getOutputPanel().setOutput("Training Target file loaded from "+Annotator.targetFile+ ".");
			controlPanel.getOutputPanel().setOutput("Testing Images loaded from "+testdirField.getText().trim()+ ".");
			controlPanel.getOutputPanel().setOutput("Testing Target file loaded from "+Annotator.testtargetFile+ ".");
