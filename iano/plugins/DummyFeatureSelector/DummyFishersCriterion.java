 ...
 * @author aleksey
 */
public class DummyFishersCriterion implements FeatureSelector
{
    /*
    ...
    public DummyFishersCriterion(HashMap<String, String> parameters) {
        if (parameters.containsKey("MULTICLASS COMPARISON METHOD")) {
            if (parameters.get("MULTICLASS COMPARISON METHOD").equals("PAIRWISE")) {
                this.multiclass_comparison_method = "PAIRWISE";
            }
    ...
    public DummyFishersCriterion(float[][] features, int[] classes, HashMap parameters) {
