...
import annotool.extract.CompSumDouble;
...
public class ObjectSelection {
	...
	private void calcRegionSD(final ImageProcessor eqIP, int radius) {
		//Get circular ROI around the center
		
		//Calculate sd within the ROI
	}
